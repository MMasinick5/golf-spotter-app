          ...
          <div style={{ display: "flex", gap: 6, alignItems: "center", marginTop: 4 }}>
            ...
            >
              ...
              <div style={{ textAlign: "center" }}>
                ...
                <p style={{ fontSize: 22, fontWeight: 600, color: "#fff", lineHeight: 1 }}>
                  {hole}
                </p>
              </div>
              <button
        ...
        {currentPlayer && (
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              <p style={{ fontWeight: 600, color: "#fff", fontSize: 16 }}>
                {currentPlayer.name}
              </p>
            </div>
            <div style={{ textAlign: "right" }}>
              ...
              <p style={{ fontWeight: 700, color: "#fff", fontSize: 22, lineHeight: 1 }}>
                #{shotNumber}
              </p>
            </div>
          </div>
                ...
                {activePlayers.map((player, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div style={{ flex: 1 }}>
                        <p
                          style={{
                            ...
                            color: isCurrent ? "#0F6E56" : "var(--color-text-primary)"
                          }}
                        >
                          {player.name}
                        </p>
                      ...
                      {isCurrent && <Pill color="#0F6E56" bg="#E1F5EE">Hitting</Pill>}
            ...
            {holeEntries.length > 0 && (
              ...
              >
                ...
                {holeEntries.slice(0, 3).map((entry, idx) => {
                  const cfg = STATUS_CONFIG[entry.status] || STATUS_CONFIG.Ready;
                  return (
                    <div
                      key={entry.id}
                      style={{
                        padding: "10px 16px",
                        borderBottom:
                          idx < Math.min(holeEntries.length, 3) - 1
                            ? "0.5px solid var(--color-border-tertiary)"
                            : "none",
                        display: "flex",
                        gap: 10,
                    ...
                    >
                      <Avatar
                        ...
                        color={playerColor(entry.player.id)}
                        bg={playerBg(entry.player.id)}
                        size={30}
                      />
                      <div style={{ flex: 1 }}>
              ...
              <div style={{ display: "flex", padding: 16, gap: 10 }}>
                {[2, 3, 4].map((n) => (
                  <button
                    ...
                    onClick={() => {
                      setPlayerCount(n);
                      if (currentPlayerId > n) setCurrentPlayerId(1);
                    }}
                    style={{
                      flex: 1,
                      padding: "12px 0",
